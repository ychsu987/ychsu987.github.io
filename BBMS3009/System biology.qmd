---
title: "Bridging Genome to Function: Post-Genome Science"
author: Yu Cheng Hsu
format: 
  revealjs:
...
![ChIP-seq Data Visualization](image/chip-seq.png){.absolute .fragment .fade-in width=200 height=100 top=300 left=200}
![Differentially Expressed Genes Heatmap](image/deg.png){.absolute .fragment .fade-in width=200 height=200 top=450 left=200}
![Gene Ontology Logo](image/go-logo.png){.absolute .fragment .fade-in width=300 height=100 top=350 left=400}
![KEGG Pathway Model](image/kegg_model.png){.absolute .fragment .fade-in width=300 height=250 top=400 left=400}

::: {.fragment .fade-in .absolute width=300 height=100 top=300 left=750}
...
::: {.column width="50%"}
![Insulin Secretion Process](image/insulin.png)
:::
...
::: {.column width="50%"}
![Gene Ontology Annotation for Insulin Secretion](image/GO_insulin.png)
:::
...
![Overview of Enrichment Analysis @khatri2012ten](image/enrichment.png){height=350}
...
![ChIP-seq Data Visualization](image/chip-seq.png){height=400}
...
::: {.column width="40%"}
![Motivation Example @welch2014chip](image/GREAT.png)
:::
...
![Pathway Enrichment](image/ora.png)
...
- 10,000 ($N$) genes detected in a microarray study
  - 100 ($M$, G1-G4,G10001~G10096) of them belong to pathway <span style="color: red;">$\pi$</span>
  - 50 ($n$) genes were differentially expressed

|        | DE | NOT DE | Row sum |
|--|--|--|--|
| In $\pi$ | <span class="hide">4(a)</span> |<span class="hide"> 96(b)</span> | <span class="hide">100 ($M$)</span> |
| NOT in $\pi$ | <span class="hide">46(c)</span> | <span class="hide">9854(d)</span> | <span class="hide">9900 ($N-M$)</span>|
| Column sum | <span class="hide">50 ($n$)</span> |<span class="hide"> 9950 ($N-n$)</span> | <span class="hide">10000 ($N$)</span> |
:::
...
1. $a:c \geq b:d$ is equivalent to $\frac{a}{c} \geq \frac{b}{d} \text{ or } ad \geq bc$, so you can swap the columns and rows in the previous table 
2. For any cell with a larger number, Fisher's exact test approximates to the Chi-square test 
:::
...
:::{.hide}
$$
P = \sum_{i=4}^{100}\frac{\binom{100}{i}\binom{9900}{50-i}}{\binom{10000}{50}} = 1- \sum_{i=0}^{3} \frac{\binom{100}{i}\binom{9900}{50-i}}{\binom{10000}{50}}
= 0.0015
$$
:::
...
:::{.column}
![Illustration of GSEA @subramanian2005gene; Top:Upregulation, Middle: Not enriched, Bottom: Downregulation](image\gsea.png){height="350"}
:::
...
| Rank | Gene | Hit/Miss | Score |
| ---- | ---- | -------- | ----- |
| 1    |  <span class="hide">G8</span>  |   <span class="hide">Hit</span>    | <span class="hide">-1/3</span> |
| 2    |  <span class="hide">G7</span>  |   <span class="hide">Hit</span>    | <span class="hide">-1/3</span> |
| 3    |  <span class="hide">G6</span>  |   <span class="hide">Hit</span>    | <span class="hide">-1/3</span> |
| 4    |  <span class="hide">G2</span>  |  <span class="hide">Miss</span>    | <span class="hide">0.1/7</span>  |
| 5    |  <span class="hide">G5</span>  |   <span class="hide">Hit</span>    | <span class="hide">0.9/7</span> |
| 6    |  <span class="hide">G4</span>  |  <span class="hide">Miss</span>    | <span class="hide">1.7/4</span>  |
| 7    |  <span class="hide">G1</span>  |  <span class="hide">Miss</span>    | <span class="hide">2/4</span>  |
| 8    |  <span class="hide">G3</span>  |  <span class="hide">Miss</span>    | <span class="hide">2.3/4</span>  |
...
::: {.r-stack}
![Simplified Insulin Pathway](image/insulin.png){.fragment }

![Complex Insulin Pathway](image/insulin_2.png){.fragment}
:::
...
![STRING Protein-Protein Interaction Network for Color Blindness](image/string_color_blindness.png)
...
![Application of PPI](image/ppi.jpg){height=300}
