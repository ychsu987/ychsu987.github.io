...
#| echo: true
#| eval: true
#| fig-cap: Scatter plot for Sepal length and Pedal width
...
**Some notes** ^[If you find the figure behave not as expected. The best choice is alwayslook up on the documentation, or ask AI.]: `color` affects the border color (dots/lines), `fill` affects the rectangle color
