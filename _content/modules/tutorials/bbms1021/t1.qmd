...
1. What will be the data type of fakedata?

2. If we calculate `mean(fakedata)`, it will result in an error. Why does this happen, and how should we fix the error?

::: {.hide}
Answer key:

1. Character
2. Mean can only work on integer or numeric datatype. you need to force the data to become numeric again 
