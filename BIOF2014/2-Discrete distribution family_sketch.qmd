...
format: 
  revealjs:
    ...
    chalkboard:
      theme: whiteboard
      src: compiled_pdf/chalkboard 3.json
lightbox: true
---
...
:::::: columns
::: column
Suppose we have $N$ iid trials with success probability $p$, resulting in random variables $\mathbf{X} = [X_1, \ldots, X_N]$ such that 
$$
...
|-----|-----------------------|----------------------|-------------------------|
| 0   | $\{ 000 \}$           | [$(1-p)^3$ ]{.hide}  | [$\binom{3}{0}$]{.hide} |
| 1   | $\{ 100, 010, 001 \}$ | [$p(1-p)^2$ ]{.hide} | [$\binom{3}{1}$]{.hide} |
| 2   | $\{ 110, 101, 011 \}$ | [$p^2(1-p)$]{.hide}  | [$\binom{3}{2}$]{.hide} |
| 3   | $\{ 111 \}$           | [$p^3$ ]{.hide}      | [$\binom{3}{3}$]{.hide} |
