...
&= \frac{k!}{k!}\sum_{i=0}^k \frac{\lambda_1^i}{i!} \frac{\lambda_2^{k-i}}{k-i!} e^{-\lambda_1} e^{-\lambda_2} \\
&= \sum_{i=0}^k k!\frac{\lambda_1^i}{i!} \frac{\lambda_2^{k-i}}{k-i!} \frac{e^{-(\lambda_1+\lambda_2)}}{k!} \\
